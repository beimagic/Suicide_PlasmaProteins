# This script was used to perform protein-imaging association analysis for SGM
imaging_data <- as.data.frame(fread(paste0(path_wd,"**.csv")))
...
lable <- as.data.frame(fread(paste0(path_wd,"**.csv")))
